...
export const authSlice = createSlice({
    ...
    reducers: {
        ...
        addGroup : (state,action) => {
            console.log('payload ',action.payload.newGroup)
            state.groups.unshift(action.payload.newGroup);
        }
    },
});

export const { setMode, setLogin, setLogout, setPosts, setPost, setUser, setMessages, setToken, setReviews ,setNotifications, setGroups, addGroup, pushMessages} =
    authSlice.actions;
