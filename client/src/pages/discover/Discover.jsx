  ...
  return (
    <div className="discoverPage pt-5">
      <input
        ...
        placeholder="Discover movie or friend"
      />
      <div className="d-flex justify-content-center">
        <button
          className={`btn-lg m-3 btn  ${searchType === "movies" ? "btn-outline-success disabled" : "btn-success"}`}
          onClick={() => {
        ...
        <button
          className={`btn-lg m-3 mx-0 btn  ${searchType === "users" ? "btn-outline-success disabled" : "btn-success"}`}
          onClick={() => {
            setSearchType("users");
            setMovies([]);
          }}
