          ...
          <div className="right">
            <div className="set1">
              ...
              {notification?.type === "follow" && (
                <span className="level2"> started following you </span>
              )}
              {notification?.type === "replied" && (
                <span className="level2">
                  ...
                  <Link
                    ...
                    to={`/movie/${notification.movieTitle}/${notification.movieId}`}
                  >
        ...
        <>
          <div className="left">
            {notification?.notificationBy?.profilePicture !== "" ? (
              <Link
                className="link"
                to={`/profile/${notification?.notificationBy._id}`}
              >
                <img
                  src={notification?.notificationBy?.profilePicture}
                  alt=""
                />
              </Link>
            ) : (
            ...
            <div className="set1">
              <div className="level1">
                <span className="text-bold fs-3">
                  ...
                  >
                    {" "}
                    {notification?.notificationBy?.name}{" "}
                  </Link>
                </span>
              </div>
              ...
              {notification?.type === "follow" && (
                <span className="level2">
                  <span className="px-2">
                    @{notification?.notificationBy?.username}
                  </span>{" "}
