...
function AddReview({ movieDetails }) {
    ...
    const notifyReviewExists = () => toast.error("Your review already exists", {
        position: toast.POSITION.TOP_RIGHT
      });
    ...
    const handleSubmit = async (e) =>{
        ...
        try {
            ...
            const result = await axios.post(`api/user/review/${currentUser._id}/${movieDetails.id}`,{
                rating : rating,
    ...
    return (
        <div>
            ...
            <button type="button" className="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Add Review</button>
                        ...
                        <div className="modal-body" >
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="modal-footer ">
                                    ...
                                    <button type="submit" className="btn btn-success" data-bs-dismiss='modalT'>Post Review</button>
                                </div>
                            </form>
                        </div>
                    </div>
