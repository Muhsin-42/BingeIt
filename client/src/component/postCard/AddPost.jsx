...
const AddPost = () => {
    ...
    return (
        <>
          ...
          <Tooltip onClick={(e) => setOpen(true)} title="Addpost"
          ...
          <StyledModal open={open}
            ...
            <Box  width={400}  height={image || files[0] ? 450 : 320}
              ...
              <TextField onChange={(e) => setPostContent(e.target.value)}
                sx={{ width: "100%" }}
                id="standard-multiline-static"  multiline  rows={3}  variant="standard"
                placeholder="Write your caption! (Note: post related to movies only)"
              />
              {!files[0] && (
                <Box
