...
const AddPost = () => {
  ...
  const notifyMinimun = () =>
    toast.warn("Caption should be atleast 10 characters.", {
  ...
  const uploadPost = async (uploadImageName) => {
    try {
      const result = await axios.post(
        `api/post/post/${currentUser._id}`,
        { data: uploadImageName, content: postContent },
        {
          headers: {
